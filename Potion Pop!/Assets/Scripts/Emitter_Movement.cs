...
public class Emitter_Movement : MonoBehaviour
{
    ...
    [Range(0, 0.3f)] public float yOffset = 0.2f;
    [Range(0, 0.15f)] public float xOffset = 0.07f;
    [Range(0, 0.2f)] public float uiPositionOffset = 0.14f;
    ...
    void Start() {
        ...
        rightTopCorner = Camera.main.ViewportToWorldPoint(new Vector3(1f - xOffset - uiPositionOffset, 1f + yOffset, 1));
    }
